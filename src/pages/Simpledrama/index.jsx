  ...
  return (
    <>
      <div className="bg-gray-100 border border-black-900 border-solid flex flex-col font-inter gap-[43px] items-center justify-start mx-auto w-full">
        ...
        <div className="flex flex-col md:gap-10 gap-[72px] items-center justify-start max-w-[1341px] mx-auto md:px-5 w-full">
            ...
            <div className="flex flex-col items-center justify-start w-[98%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-[45px] items-center justify-between w-full">
                <div className="h-[251px] relative w-[22%] md:w-full">
                  ...
                  />
                  <Text
                    className="common-pointer absolute bottom-[11%] inset-x-[0] mx-auto sm:text-[31px] md:text-[33px] text-[35px] text-black-900 text-center tracking-[-0.18px] w-max"
          ...
          <div className="flex flex-col justify-start w-full">
            ...
            <div className="bg-gray-50 border border-black-900 border-solid flex flex-row items-center justify-start mt-[3px] pt-0.5 px-0.5 w-full">
              <div className="flex sm:flex-col flex-row gap-8 items-center justify-between w-[37%]">
                <Img
...
export default SimpledramaPage;
