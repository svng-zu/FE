...
const Reclist = ({ rankposter }) => {
  ...
  return (
    <div style={{ position: 'relative', display: 'flex', alignItems: 'center', marginLeft: '11.5%', marginRight: '-500%' }}>
      ...
      <div style={{ position: 'relative', display: 'flex', overflowX: 'auto', height:'270px', marginLeft: '2%', marginRight: '0', minWidth: '100%', maxWidth: '100%' }} ref={containerRef}>
        {rankposter.map((item, index) => (
          <img className='img'
            key={index}
            style={{ width: '200px', height: '260px', marginRight: '10px', border:'1px' , cursor: 'pointer' }}
            src={item[2]}
            alt={`${index}`}
